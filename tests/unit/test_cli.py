"""Regression: nuclear_morphometry.cli must not import napari/Qt at module load
...
qc/viewer.py (or napari itself) unconditionally, every `nuclear-morphometry`
invocation would require it, not just `nuclear-morphometry qc`.
"""
...
def test_importing_cli_does_not_import_napari() -> None:
    result = subprocess.run(
        [
            sys.executable,
            "-c",
            "import sys; import nuclear_morphometry.cli; "
